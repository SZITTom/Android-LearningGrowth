...
import com.yun.library.R;
import com.yun.library.tablayout.listener.CustomTabEntity;
import com.yun.library.tablayout.listener.OnTabSelectListener;
import com.yun.library.tablayout.utils.FragmentChangeManager;
import com.yun.library.tablayout.utils.UnreadMsgUtils;
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public RelativeLayout getContentView(int tab) {
        View tabView = mTabsContainer.getChildAt(tab);
        RelativeLayout tv_tab_title = (RelativeLayout) tabView.findViewById(R.id.re_tab);
        return tv_tab_title;
    }
